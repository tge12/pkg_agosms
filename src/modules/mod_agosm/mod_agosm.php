...
{
  $document->addStyleSheet(JURI::root(true) . '/media/mod_agosm/js/theme.jui.css');
  $document->addStyleSheet(JURI::root(true) . '/media/mod_agosm/js/jquery.tablesorter.pager.css');
  $document->addScript(JURI::root(true) . '/media/mod_agosm/js/jquery.tablesorter.js');
  $document->addScript(JURI::root(true) . '/media/mod_agosm/js/jquery.tablesorter.pager.js');
  $document->addScript(JURI::root(true) . '/media/mod_agosm/js/jquery.tablesorter.widgets.js');
}
// TGE END
